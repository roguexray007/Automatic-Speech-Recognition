...
# python preprocessing.py /Users/hardxray007/Documents /Users/hardxray007/Desktop/preprocess -l phn
	...
	for subdir, dirs, files in os.walk(rootdir):
		for file in files:
			...
			if file.endswith('.WAV'):
				(sig, rate) = librosa.load(fullFilename)
...
if __name__ == '__main__':
	...
	wav2feature(root_directory, save_directory, mode=mode, feature_len=feature_len, level=level, keywords=name,
				win_len=win_len, win_step=win_step, seq2seq=seq2seq, save=True)

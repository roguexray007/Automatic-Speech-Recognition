...
flags.DEFINE_string('datadir', '/Users/hardxray007/Desktop/preprocess', 'set the data root directory')
flags.DEFINE_string('logdir', '/Users/hardxray007/Desktop/log', 'set the log directory')
